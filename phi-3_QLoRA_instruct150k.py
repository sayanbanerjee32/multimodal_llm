...
!pip install -Uq accelerate peft bitsandbytes trl dataset bitsandbytes transformers
...
loaded_projector_state = torch.load(final_model_path + '/image_projector.pth')
